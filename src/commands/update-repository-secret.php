...
class Update_Repository_Secret extends Command {
	...
	protected function execute( InputInterface $input, OutputInterface $output ): void {
		...
		$this->update_repo_secret( $sealbox, $repo_public_key_id );
	}
	 ...
	 */
	private function update_repo_secret( string $sealbox, int $key_id, string $secret_name = 'TEAM51_REPO_SECRET' ) {
